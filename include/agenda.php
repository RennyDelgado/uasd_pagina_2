...
<div class="container agenda">
	...
	<div class="col-lg-5 col-md-5 col-xs-5 float-left agenda_dias"
      style="background-image:url(img/image_agenda.png)">
...
<div class="carousel-item active">
        <div class="detalles-horas">
          <p class="hora_agenda">10:00 A.M.</p>
          <hr class="regla juridica"></hr>
          ...
          <hr class="regla_divicion"></hr>
          </div>
          <div class="detalles-horas">
            <p class="hora_agenda">10:00 A.M.</p>
            <hr class="regla ciencia"></hr>
            <p class="texto_agenda">Entrega de Título Doctor Honoris Causa al
              Señor Ignacio Ramonet, de la facultad de Humanidades</p>
            <img src="img/icono_agenda.svg" class="img-fluid pull-xs-left lugar_icono" alt="...">
            <p class="ubicacion">Paraninfo Facultad de Ciencias Económicas y Sociales</p>
...
<div class="carousel-item active">
        <div class="detalles-horas">
          <p class="hora_agenda">10:00 A.M.</p>
          <hr class="regla juridica"></hr>
          <p class="texto_agenda">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
